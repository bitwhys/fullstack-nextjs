        ...
        <div className="relative mx-auto max-w-lg rounded-xl border border-olive7 bg-olive1 px-6 pt-16 pb-16 md:px-10 lg:px-16">
          ...
          <div className="relative mx-auto max-w-md">
            <div className="mb-10 text-center">
              <h2 className="mb-2 text-2xl font-semibold text-olive12">We&apos;ve been thinking about you!</h2>
              <p className="font-medium text-olive11">login to your account</p>
            </div>
            <form action="">
              ...
              <button className="mb-4 block w-full rounded-lg bg-primary-500 py-4 text-xl font-semibold leading-6 text-black transition duration-200 hover:bg-primary-400">
                Login in
              </button>
              <button className="mb-6 flex w-full items-center justify-center rounded-lg bg-olive4 py-4 font-semibold leading-6 text-white transition duration-200 hover:bg-olive5">
                ...
                <span className="ml-3">Login with Gmail</span>
              </button>
              <p className="flex items-center justify-center gap-x-2 text-center font-medium">
                <span className="text-gray-300">Don&apos;t have an account?</span>
                <Link className="inline-block text-primary-500 hover:underline" href="/register">
                  Register
                </Link>
              </p>
            </form>
